...
; I use the LSR correction method given by Carl Heiles:
; https://www.gb.nrao.edu/GBT/DA/gbtidl/release/user/toolbox/chdoppler.pro
...
mjd = median(tab.UTOBS)

;print, median(tab.UTOBS), format = '(d)'
...
;Here I copy the code from https://www.gb.nrao.edu/GBT/DA/gbtidl/release/user/toolbox/chdoppler.pro which is used for GBT.
;#----- LSR SECTION----------
