...
N_spec = N_spec_tab2 + N_spec_tab3 + N_spec_tab4
...
for i_time = 0, N_spec - 1 do begin
	...
	if i_time ge N_spec_tab2 + N_spec_tab3 then spec_ADU[i_time,*] = tab4[i_time-N_spec_tab2-N_spec_tab3].data[polar_ID, ind_freq] 
